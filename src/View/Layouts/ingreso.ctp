...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <?php
            ...
            echo $this->Html->css('http://localhost:9191/libs/extjs-4.1.1/resources/css/ext-all.css', 'stylesheet', $opciones);
            echo $this->Html->script('http://localhost:9191/libs/extjs-4.1.1/ext-all-dev.js', $opciones);
